...
namespace Common.Repository.Application
{
    public class TicketRepository : ITicketRepository
    {
        ...
        {
            var get = applicationContext.Tickets.Include("Status").Include("Project").Where(x => x.IsDelete == false).ToList();
            return get;
        }

        public Ticket Get(int id)
        {
            var get = applicationContext.Tickets.Find(id);
            return get;
        }

        public List<Ticket> GetSearch(string values)
        {
            var get = applicationContext.Tickets.Include("Status").Include("Project").Where
